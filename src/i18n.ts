...
const EN: Dict = {
  ...
  "btn.new": "New",
  "btn.example": "Example",
  "support.kofi": "☕ Buy me a coffee",
  "support.kofi.title": "Support the project on Ko-fi (opens in a new tab)",
...
const DE: Dict = {
  ...
  "support.kofi": "☕ Kaffee spendieren",
  "support.kofi.title": "Projekt auf Ko-fi unterstützen (öffnet in neuem Tab)",
